...
type formDataType = Omit<ReadHpScheduleManagementFormDataType, 'scheduleId'>
const App: React.FC<Props> = ({
    ...
    const onFinish = (value: formDataType) => {
        ...
        //TODO editeOneRow
        if (isEdite) {
            editUserOneRow({ scheduleId: selectRowKey!, ...value })
        } else {
            //TODO addOneRow
            addUserOneRow({  ...value })
            console.log(value)
        ...
        <>
            <Modal
                ...
                <Form
                    ...
                    <Form.Item name="nurseId" rules={[{ required: true }]}>
                        <Input placeholder="请输入护士ID" />
                    </Form.Item>
                    <Form.Item name="scheduleDate" rules={[{ required: true }]}>
                        <Input placeholder="请输入日期" />
                    </Form.Item>
                    <Form.Item name="timeSlot" rules={[{ required: true }]}>
