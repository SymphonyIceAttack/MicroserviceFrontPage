...
import { ReadHpRecordsManagementFormDataType } from '../types'
...
type formDataType = Omit<ReadHpRecordsManagementFormDataType, 'recordId'>
const App: React.FC<Props> = ({
    ...
    const onFinish = (value: formDataType) => {
        ...
        //TODO editeOneRow
        if (isEdite) {
            editUserOneRow({ recordId: selectRowKey!, ...value })
        } else {
            //TODO addOneRow
            addUserOneRow({  ...value })
            console.log(value)
        ...
        <>
            <Modal
                ...
                <Form
                    ...
                    <Form.Item name="patientId" rules={[{ required: true }]}>
                    ...
                    <Form.Item name="prescription" rules={[{ required: true }]}>
                        <Input placeholder="请输入处方药物" />
                    </Form.Item>
                </Form>
            </Modal>
        </>
